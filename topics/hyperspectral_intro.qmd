...
{{< video https://www.youtube.com/embed/_dSAbX8F2hg?si=FXhPgYEjnqxWCXb9 >}}
...
Read the [**theory**](hyperspectral_theory.qmd)

Analyze real data with a [**practical tutorial in R**](hyperspectral_tutorial.qmd)